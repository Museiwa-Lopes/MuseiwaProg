...
<html>
<head>
  <title>Gerenciar chefes - PRM | MuseiwaProg</title>
  <link rel="icon" type="image/png" href="../image/emblema_mocambique.png">
  ...
  <script>
    ...
    function confirmDelete(chefeId) {
      if (confirm("Tem certeza de que deseja apagar este chefe?")) {
        window.location.href = "excluir_chefe.php?id=" + chefeId;
      }
    }
  </script>
</head>
    ...
    <div class="content">
      ...
      <div class="cheads-list">
        ...
        <div class="add-button-container">
          <a href="/admin/adicionar_chefe.php"><button class="add-button">+ Adicionar</button></a>
