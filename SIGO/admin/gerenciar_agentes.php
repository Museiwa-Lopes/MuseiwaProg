...
<html>
<head>
    <title>Gerenciar agentes - PRM | MuseiwaProg</title>
    <link rel="icon" type="image/png" href="../image/emblema_mocambique.png">
...
<script>
    ...
    function confirmDelete(adminId) {
        if (confirm("Tem certeza de que deseja apagar este administrador?")) {
            window.location.href = "excluiradmin.php?distintivo=" + adminId;
        }
    }
</script>
...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="cheads-list">
            <h3>Lista dos agentes</h3>
            <div class="add-button-container">
                <a href="/admin/cadastrar_agente.php"><button class="add-button">+ Cadastrar</button></a>
