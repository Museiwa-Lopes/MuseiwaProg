...
if (isset($_SESSION["id_usuario"])) {
    ...
    die("ID do agente não especificado.");
}
...
<head>
    <meta charset="UTF-8">
    <title>Editar Perfil - Agente | MuseiwaProg</title>
...
<form method="post">
    <div class="form-row">
        <div>
            ...
            <input type="text" id="name" name="name" value="<?= htmlspecialchars($agente['nome']) ?>" required>
        </div>
        <div>
            <label for="nickname">Apelido:</label>
            <input type="text" id="nickname" name="nickname" value="<?= htmlspecialchars($agente['apelido']) ?>" required>
        </div>
    </div>
    ...
    <div>
        ...
        <select id="gender" name="gender" required>
            ...
            <option value="Feminino" <?= $agente['genero'] === 'Feminino' ? 'selected' : '' ?>>Feminino</option>
        </select>
    </div>

    <div>
        <label for="badge-number">N° de distintivo:</label>
        <input type="text" id="badge-number" name="badge-number" maxlength="6" value="<?= htmlspecialchars($agente['distintivo']) ?>" required>
    </div>
