...
<body>
  <h3 style="text-align: center;"><img src="<?= __DIR__ . '/../image/ .png' ?>" style="width: 100px; display: block; margin: 0 auto 10px;">
<br>REPÚBLICA DE MOÇAMBIQUE<br>MINISTÉRIO DO INTERIOR<br>COMANDO DISTRITAL DA PRM-VILANKULO</h3>
